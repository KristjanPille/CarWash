...
namespace WebApp.Controllers
{
    public class DiscountsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Discounts.Include(d => d.Check).Include(d => d.Wash);
        ...
        public async Task<IActionResult> Create([Bind("discountID,checkID,washID")] Discount discount)
        {
            ...
            ViewData["checkID"] = new SelectList(_context.Checks, "checkID", "checkID", discount.checkID);
            ViewData["washID"] = new SelectList(_context.Washes, "washID", "washID", discount.washID);
            return View(discount);
        }
