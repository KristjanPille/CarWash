...
{
    public class WashTypeRepository : EFBaseRepository<AppDbContext, Domain.WashType, DAL.App.DTO.WashType>, IWashTypeRepository
    {
        public WashTypeRepository(AppDbContext dbContext) : base(dbContext, new BaseDALMapper<Domain.WashType, DAL.App.DTO.WashType>())
        {
        }
        ...
        public async Task<DTO.WashType> FirstOrDefaultAsync(Guid id, Guid? userId = null)
        {
