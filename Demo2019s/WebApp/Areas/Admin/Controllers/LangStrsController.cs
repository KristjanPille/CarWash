...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class LangStrsController : Controller
    {
        ...
        // GET: Admin/LangStrs/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/LangStrs/Create
