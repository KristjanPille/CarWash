...
namespace WebApp.Controllers
{
    public class CarsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Cars.Include(c => c.CarType).Include(c => c.Person);
        ...
        public async Task<IActionResult> Create([Bind("carID,carTypeID,personID,licenceNr")] Car car)
        {
            ...
            ViewData["personID"] = new SelectList(_context.Persons, "personID", "personID", car.personID);
            return View(car);
        }
