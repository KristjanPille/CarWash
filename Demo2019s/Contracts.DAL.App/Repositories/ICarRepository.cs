...
{
    public interface ICarRepository : ICarRepository<Guid, Car>, IBaseRepository<Car>
    {
    }

    public interface ICarRepository<TKey, TDALEntity> : IBaseRepository<TKey,TDALEntity> 
