...
{
    public interface IWashRepository : IWashRepository<Guid, Wash>, IBaseRepository<Wash>
    {
    }

    public interface IWashRepository<TKey, TDALEntity> : IBaseRepository<TKey,TDALEntity> 
